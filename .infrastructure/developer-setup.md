...
**Target Audience**: Developers working on Agentic Armor
...
```bash
git clone https://github.com/calebrosario/agentic-armor.git
cd agentic-armor
```

### 1.2 Install Dependencies

_(Note: package.json will be created in Phase 0 Infrastructure Week)_
...
_Output should show: "Connected to Docker Engine API v1.47+"_
